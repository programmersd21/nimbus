"""
spring.py — nimbus Spring Physics Engine
...
class Spring:
    ...
    def __init__(self, value: float, stiffness: float = 300.0, damping: float = 30.0):
...
SPRING_SNAPPY = {"stiffness": 480, "damping": 36}  # Fast, minimal overshoot
SPRING_BOUNCY = {"stiffness": 380, "damping": 22}  # Playful, slight bounce
SPRING_GENTLE = {"stiffness": 180, "damping": 24}  # Slow, smooth transitions
SPRING_STIFF = {"stiffness": 700, "damping": 45}  # Near-instant, very tight


def make_spring(value: float, preset: dict) -> Spring:
    """Convenience factory: Spring(value, **preset)."""
    return Spring(value, **preset)
